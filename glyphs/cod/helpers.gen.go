...
var (
	allGlyphs = map[string]nf.Glyph{
		...
		"chat_sparkle_error":           ChatSparkleError,
		"chat_sparkle_warning":         ChatSparkleWarning,
		"check":                        Check,
		"check_all":                    CheckAll,
		"checklist":                    Checklist,
		...
		"comment_discussion_quote":     CommentDiscussionQuote,
		"comment_discussion_sparkle":   CommentDiscussionSparkle,
		...
		"copilot":                      Copilot,
		"copilot_blocked":              CopilotBlocked,
		"copilot_error":                CopilotError,
		"copilot_in_progress":          CopilotInProgress,
		"copilot_large":                CopilotLarge,
		"copilot_not_connected":        CopilotNotConnected,
		"copilot_snooze":               CopilotSnooze,
		"copilot_success":              CopilotSuccess,
		"copilot_unavailable":          CopilotUnavailable,
		"copilot_warning":              CopilotWarning,
		"copilot_warning_large":        CopilotWarningLarge,
		"copy":                         Copy,
		"coverage":                     Coverage,
		...
		"debug_connected":                         DebugConnected,
		...
		"diff_multiple":                           DiffMultiple,
		"diff_removed":                            DiffRemoved,
		"diff_renamed":                            DiffRenamed,
		"diff_single":                             DiffSingle,
		"discard":                                 Discard,
		"download":                                Download,
		"edit":                                    Edit,
		"edit_code":                               EditCode,
		"edit_session":                            EditSession,
		"edit_sparkle":                            EditSparkle,
		...
		"extensions_large":                        ExtensionsLarge,
		"eye":                                     Eye,
		...
		"git_branch_changes":                      GitBranchChanges,
		"git_branch_conflicts":                    GitBranchConflicts,
		"git_branch_staged_changes":               GitBranchStagedChanges,
		...
		"git_pull_request_done":                   GitPullRequestDone,
		...
		"globe":                                   Globe,
		"go_to_editing_session":                   GoToEditingSession,
		"go_to_file":                              GoToFile,
		...
		"keyboard_tab_above":                      KeyboardTabAbove,
		"keyboard_tab_below":                      KeyboardTabBelow,
		"law":                                     Law,
		"layers":                                  Layers,
		...
		"layout_panel_dock":                       LayoutPanelDock,
		...
		"map_vertical":                            MapVertical,
		"map_vertical_filled":                     MapVerticalFilled,
		"markdown":                                Markdown,
		"mcp":                                     Mcp,
		"megaphone":                               Megaphone,
		"mention":                                 Mention,
		...
		"run_above":                               RunAbove,
		"run_all":                                 RunAll,
		"run_all_coverage":                        RunAllCoverage,
		"run_below":                               RunBelow,
		"run_coverage":                            RunCoverage,
		"run_errors":                              RunErrors,
		"run_with_deps":                           RunWithDeps,
		"save":                                    Save,
		"save_all":                                SaveAll,
		"save_as":                                 SaveAs,
		...
		"send":                                    Send,
		"send_to_remote_agent":                    SendToRemoteAgent,
		"server":                                  Server,
		...
		"symbol_method_arrow":                     SymbolMethodArrow,
		...
		"terminal_git_bash":                       TerminalGitBash,
		...
		"vr":                                      Vr,
		"vscode":                                  Vscode,
		"vscode_insiders":                         VscodeInsiders,
		"wand":                                    Wand,
		"warning":                                 Warning,
		"watch":                                   Watch,
